...
int main(int argc, char** argv) {
  ...
  pose_cmd_two.pose.position.x = 1;
  pose_cmd_two.pose.position.y = -1;
  pose_cmd_two.pose.position.z = 4;

  geometry_msgs::PoseStamped pose_cmd_three;
  pose_cmd_three.pose.position.x = 1.5;
  pose_cmd_three.pose.position.y = 0;
  pose_cmd_three.pose.position.z = 5;
